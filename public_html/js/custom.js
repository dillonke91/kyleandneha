...
(function($) {
    ...
    $(document).ready(function() {
        ...
        ==================================================================================== */
        var instagramTag = 'kyleandnehawedding'; // Add Instagram Tag here
        var instagramClientId = '08395aad207044abbb7ae5ad07c6fbf8'; // Add ClientId here
        ...
        ==================================================================================== */
        if($("#countdown").length) {
            CountDownTimer('12/20/2016 12:00 AM', 'countdown');
        }
